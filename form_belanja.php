...
<body>
            ...
            <div class="row">
              <div class="col-8">
                <form method="POST" action="form_belanja.php" class="form-horizontal ">
                  <h1 class="text-primary">ONLINE SHOP</h1>
                  <hr>
                ...
                <!------------------------>
                  ...
                  <fieldset class="form-group">
                    <div class="row">
                      <legend class="col-form-label col-sm-4 pt-0"><b>Produk</b></legend>
                      <div class="col-sm-8">
              ...
              <div class="col-4 " >
                  <ul class="p-1 bg-white" style="list-style-type:none;border:1px solid #c4c4c4;">
                    ...
                    <li class="p-2">TV : 3.000.000</li>
                    <li class="p-2 bg-light">Kulkas : 5.000.000</li>
                    <li class="p-2">Mesin Cuci : 4.000.000</li>
        ...
        <div class="container-fluid bg-light mt-5 mb-5 p-5 shadow-sm">
          <h1>Output Konfirmasi Pembelian</h1>
          <br>
          <?php
          $proses= $_POST['proses']; 
          ...
          if($produk == "TV") {
            ...
            echo "<br>Total : " . 5000000 * $jumlah;
          }
          else {
            echo "<br>Total : " . 4000000 * $jumlah;
          }
          ?>
        </div>
